...
def weather():
    ...
    try:
        ...
        forecast_data = [entry['main']['temp'] for entry in data['list'][:5]]
        current = data['list'][0]
        ...
        # Generate random weather data for next 24 hours (simplified to 24 data points)
        ...
        earthquake_possibility_data = [round(random.uniform(0, 1), 2) for _ in range(24)]  # 0 to 1 scale

        # Current values as the first data point
        ...
        # Predict flood risk based on rain and humidity
        ...
        # Run alerts in a separate thread to avoid blocking
